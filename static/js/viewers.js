...
requirejs(["config"], function(config){
    requirejs(["jquery", "base", "c3", "animateNumber"], function($, base, c3) {
        var comma_separator_number_step = $.animateNumber
                                            .numberStepFactories
                                            .separator(',');
        var yday_data;
        var chart = null;
        ...
        function connect_socket() {
            ...
            ws.onmessage = function(e) {
                ...
                if (response.hasOwnProperty("viewers_today")) {
                    ...
                    var time = get_time(response.viewers_today.start,
                                         response.viewers_today.frequency * 60,
                                         yday_data.length);
