...
requirejs(["config"], function(config){
    ...
    requirejs(["jquery", "base", "d3", "colorbrewer", "bootstrap"], function($, base, d3, colorbrewer) {
     ...
     */
        ...
        var treemap = d3.layout.treemap()
                        .size([width, height])
                        .value(function(d) { return d.total_visits; })
                        .sticky(false);
        // background colors
     ...
     */
        ...
        function node_html(data) {
            return data.children ? null : data.name + " <br/><span class='badge'>" + data.total_visits + "</span>";
        }
        ...
        */
        function author_modal(data) {
            $(".modal-title")
                ...
                .html(data.name + ": <span class='badge'>" + data.total_visits + "</span> Total Visitors");
     ...
     */
        function connect_socket() {
            ...
            var ws = new WebSocket("ws://" + base.socket_domain  + "/authors-socket");
            ...
            // attempt to reconnect to socket after it has been closed
            ws.onclose = function() {
                setTimeout(function() {
                    connect_socket();
